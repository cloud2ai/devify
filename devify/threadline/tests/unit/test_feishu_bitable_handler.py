...
class TestFeishuBitableIssueHandler:
    ...
    def test_factory_accepts_feishu_bitable_alias(self, feishu_config):
    ...
    def test_create_issue_maps_fields_and_returns_record_id(
        ...
        assert called_url.endswith("/bitable/v1/apps/bascn123/tables/tbl123/records")
    ...
    def test_upload_attachments_is_noop(self, handler):
