...
This module tests the EmailClient class capabilities including:
...
from devify.threadline.utils.email_client import EmailClient
...
def email_client():
    ...
    return EmailClient(email_config, email_filter_config)
...
class TestEmailClient:
    ...
    class TestHTMLParsing:
        """Test HTML parsing capabilities of EmailClient."""

        def test_extract_text_from_html_basic(self, email_client):
            ...
            result = email_client._extract_text_from_html(html_content)
        ...
        def test_extract_text_from_html_with_images(self, email_client):
        ...
        def test_extract_text_with_placeholders(self, email_client):
            ...
            result = email_client._extract_text_with_placeholders(html_content)
        ...
        def test_embed_placeholders_in_html(self, email_client):
            ...
            result = email_client._embed_placeholders_in_html(
                html_content,
                image_placeholders
            )
        ...
        def test_extract_text_with_images_strategy(self, email_client):
            ...
            result = email_client._extract_text_with_images(
                text_content,
                html_content,
                image_placeholders
            )
        ...
        def test_extract_text_with_images_no_html_fallback(self, email_client):
        ...
        def test_html_entities_decoding(self, email_client):
        ...
        def test_html_formatting_preservation(self, email_client):
        ...
        def test_chinese_image_references(self, email_client):
        ...
        def test_english_image_references(self, email_client):
        ...
        def test_mixed_language_image_references(self, email_client):
        ...
        def test_complex_html_structure(self, email_client):
        ...
        def test_script_style_removal(self, email_client):
        ...
        def test_email_client_format(self, email_client):
        ...
        def test_error_handling(self, email_client):
            ...
            result = email_client._extract_text_from_html(malformed_html)
        ...
        def test_empty_html_handling(self, email_client):
            """Test handling of empty or minimal HTML content."""
            # Test with empty HTML
            empty_html = ""
            result = email_client._extract_text_from_html(empty_html)
            assert result == ''

            # Test with minimal HTML
            minimal_html = "<html></html>"
            result = email_client._extract_text_from_html(minimal_html)
            assert result == ''

            # Test with whitespace only HTML
            whitespace_html = "   \n  \t  "
            result = email_client._extract_text_from_html(whitespace_html)
            assert result == ''

        def test_image_placeholder_format_validation(self, email_client):
        ...
        def test_different_image_formats(self, email_client, image_src, expected_placeholder):
        ...
        def test_html_entities_decoding_comprehensive(self, email_client, entity, decoded):
