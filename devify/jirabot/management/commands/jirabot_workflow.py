"""
JiraBot Workflow CLI - Comprehensive workflow testing and management tool.
"""
import logging
import time
import json
...
from jirabot.models import EmailMessage, EmailAttachment, Settings, JiraIssue
from jirabot.state_machine import EmailStatus, AttachmentStatus
from jirabot.tasks import (
    scan_user_emails,
...
class Command(BaseCommand):
    ...
    JiraBot Workflow CLI - Comprehensive workflow testing and management tool.
    """
    help = 'JiraBot workflow CLI for testing and managing email processing workflows'
